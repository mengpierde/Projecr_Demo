export default {
    ...
    isLineIntersectRectangle (line, graphics) {
        const lineHeight = line.y0 - line.y1
        const lineWidth = line.x1 - line.x0  // 计算叉乘
        const c = line.x0 * line.y1 - line.x1 * line.y0
